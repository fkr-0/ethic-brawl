...
job_id: "item_overlay__rocket_launcher"
status: pending_render
output_image: "assets/sprites/items/rocket_launcher.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
# Rocket Launcher — `item_overlay__rocket_launcher`
...
A production overlay for Rocket Launcher; rendering kind ranged_overlay, with restrained Rocket Muzzle Flash impact language.
