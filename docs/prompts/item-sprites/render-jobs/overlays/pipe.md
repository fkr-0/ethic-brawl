...
job_id: "item_overlay__pipe"
status: pending_render
output_image: "assets/sprites/items/pipe.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
TARGET: Pipe.
A production overlay for Pipe; rendering kind melee_overlay, with restrained Metal Pipe Arc impact language.
