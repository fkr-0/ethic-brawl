...
job_id: "item_overlay__street_argument_bat"
status: pending_render
output_image: "assets/sprites/items/street_argument_bat.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
# Street Argument Bat — `item_overlay__street_argument_bat`
...
TARGET: Street Argument Bat.
A production overlay for Street Argument Bat; rendering kind melee_overlay, with restrained Blunt Swing Arc impact language.
