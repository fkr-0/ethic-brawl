...
job_id: "item_overlay__bat"
status: pending_render
output_image: "assets/sprites/items/bat.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
TARGET: Bat.
A production overlay for Bat; rendering kind melee_overlay, with restrained Bat Swing Arc impact language.
