...
job_id: "item_overlay__shovel"
status: pending_render
output_image: "assets/sprites/items/shovel.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
TARGET: Shovel.
A production overlay for Shovel; rendering kind melee_overlay, with restrained Shovel Dirt Spark impact language.
