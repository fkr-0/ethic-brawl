...
job_id: "item_overlay__rusted_short_sword"
status: pending_render
output_image: "assets/sprites/items/rusted_short_sword.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
# Rusted Short Sword — `item_overlay__rusted_short_sword`
...
TARGET: Rusted Short Sword.
A production overlay for Rusted Short Sword; rendering kind melee_overlay, with restrained Short Blade Arc impact language.
