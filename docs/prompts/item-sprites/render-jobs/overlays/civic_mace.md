...
job_id: "item_overlay__civic_mace"
status: pending_render
output_image: "assets/sprites/items/civic_mace.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
# Civic Mace — `item_overlay__civic_mace`
...
TARGET: Civic Mace.
A production overlay for Civic Mace; rendering kind melee_overlay, with restrained Heavy Blunt Arc impact language.
