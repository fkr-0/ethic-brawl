...
job_id: "item_overlay__uzi"
status: pending_render
output_image: "assets/sprites/items/uzi.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
TARGET: Uzi.
A production overlay for Uzi; rendering kind ranged_overlay, with restrained Uzi Muzzle Flash impact language.
