...
job_id: "item_overlay__minidrone"
status: pending_render
output_image: "assets/sprites/items/minidrone.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
# Minidrone — `item_overlay__minidrone`
...
TARGET: Minidrone.
A production overlay for Minidrone; rendering kind deployable_actor.
