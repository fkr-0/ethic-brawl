...
job_id: "item_overlay__neon_duelist_sword"
status: pending_render
output_image: "assets/sprites/items/neon_duelist_sword.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
# Neon Duelist Sword — `item_overlay__neon_duelist_sword`
...
TARGET: Neon Duelist Sword.
A production overlay for Neon Duelist Sword; rendering kind melee_overlay, with restrained Neon Blade Arc impact language.
