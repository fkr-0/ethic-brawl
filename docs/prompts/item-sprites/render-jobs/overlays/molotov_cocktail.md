...
job_id: "item_overlay__molotov_cocktail"
status: pending_render
output_image: "assets/sprites/items/molotov_cocktail.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
# Molotov Cocktail — `item_overlay__molotov_cocktail`
...
TARGET: Molotov Cocktail.
A production overlay for Molotov Cocktail; rendering kind throwable_overlay, with restrained Molotov Flame impact language.
