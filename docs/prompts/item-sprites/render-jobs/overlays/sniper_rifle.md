...
job_id: "item_overlay__sniper_rifle"
status: pending_render
output_image: "assets/sprites/items/sniper_rifle.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
# Sniper Rifle — `item_overlay__sniper_rifle`
...
TARGET: Sniper Rifle.
A production overlay for Sniper Rifle; rendering kind ranged_overlay, with restrained Sniper Muzzle Flash impact language.
