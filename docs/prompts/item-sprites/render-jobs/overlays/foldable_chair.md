...
job_id: "item_overlay__foldable_chair"
status: pending_render
output_image: "assets/sprites/items/foldable_chair.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
# Foldable Chair — `item_overlay__foldable_chair`
...
TARGET: Foldable Chair.
A production overlay for Foldable Chair; rendering kind melee_overlay, with restrained Chair Smash Burst impact language.
