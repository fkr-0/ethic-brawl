...
job_id: "item_overlay__riot_breaker_mace"
status: pending_render
output_image: "assets/sprites/items/riot_breaker_mace.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
# Riot Breaker Mace — `item_overlay__riot_breaker_mace`
...
TARGET: Riot Breaker Mace.
A production overlay for Riot Breaker Mace; rendering kind melee_overlay, with restrained Heavy Blunt Arc impact language.
