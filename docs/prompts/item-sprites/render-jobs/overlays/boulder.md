...
job_id: "item_overlay__boulder"
status: pending_render
output_image: "assets/sprites/items/boulder.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
TARGET: Boulder.
A production overlay for Boulder; rendering kind heavy_prop.
