...
job_id: "item_overlay__grenade"
status: pending_render
output_image: "assets/sprites/items/grenade.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
TARGET: Grenade.
A production overlay for Grenade; rendering kind throwable_overlay, with restrained Grenade Blink impact language.
