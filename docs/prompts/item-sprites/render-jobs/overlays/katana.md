...
job_id: "item_overlay__katana"
status: pending_render
output_image: "assets/sprites/items/katana.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
TARGET: Katana.
A production overlay for Katana; rendering kind melee_overlay, with restrained Katana Slash Arc impact language.
