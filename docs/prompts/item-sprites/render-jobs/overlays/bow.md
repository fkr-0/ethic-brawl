...
job_id: "item_overlay__bow"
status: pending_render
output_image: "assets/sprites/items/bow.png"
frames: 8
grid:
  columns: 4
  rows: 2
...
TARGET: Bow.
A production overlay for Bow; rendering kind ranged_overlay, with restrained Bow Release Snap impact language.
