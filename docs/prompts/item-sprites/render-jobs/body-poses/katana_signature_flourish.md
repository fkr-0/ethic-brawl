...
job_id: "item_body_pose__katana_signature_flourish"
status: pending_render
output_image: "assets/sprites/items/katana_signature_flourish.png"
frames: 1
grid:
  columns: 1
  rows: 1
...
# Katana Signature Flourish — `item_body_pose__katana_signature_flourish`
...
TARGET: Katana Signature Flourish.
A reusable full-body equipment pose template for Katana Signature Flourish. Preserve the Ethic Brawl side-view fighter proportions while making grip, weight, recoil, and silhouette mechanically unambiguous.
