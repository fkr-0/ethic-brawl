...
job_id: "item_body_pose__boulder_carry_heavy"
status: pending_render
output_image: "assets/sprites/items/boulder_carry_heavy.png"
frames: 1
grid:
  columns: 1
  rows: 1
...
# Boulder Carry Heavy — `item_body_pose__boulder_carry_heavy`
...
TARGET: Boulder Carry Heavy.
A reusable full-body equipment pose template for Boulder Carry Heavy. Preserve the Ethic Brawl side-view fighter proportions while making grip, weight, recoil, and silhouette mechanically unambiguous.
