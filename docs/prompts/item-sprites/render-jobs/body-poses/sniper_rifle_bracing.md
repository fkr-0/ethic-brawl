...
job_id: "item_body_pose__sniper_rifle_bracing"
status: pending_render
output_image: "assets/sprites/items/sniper_rifle_bracing.png"
frames: 1
grid:
  columns: 1
  rows: 1
...
# Sniper Rifle Bracing — `item_body_pose__sniper_rifle_bracing`
...
TARGET: Sniper Rifle Bracing.
A reusable full-body equipment pose template for Sniper Rifle Bracing. Preserve the Ethic Brawl side-view fighter proportions while making grip, weight, recoil, and silhouette mechanically unambiguous.
