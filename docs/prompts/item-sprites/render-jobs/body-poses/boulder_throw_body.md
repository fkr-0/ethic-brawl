...
job_id: "item_body_pose__boulder_throw_body"
status: pending_render
output_image: "assets/sprites/items/boulder_throw_body.png"
frames: 1
grid:
  columns: 1
  rows: 1
...
# Boulder Throw Body — `item_body_pose__boulder_throw_body`
...
TARGET: Boulder Throw Body.
A reusable full-body equipment pose template for Boulder Throw Body. Preserve the Ethic Brawl side-view fighter proportions while making grip, weight, recoil, and silhouette mechanically unambiguous.
