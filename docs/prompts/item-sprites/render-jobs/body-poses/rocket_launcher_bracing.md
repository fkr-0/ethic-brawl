...
job_id: "item_body_pose__rocket_launcher_bracing"
status: pending_render
output_image: "assets/sprites/items/rocket_launcher_bracing.png"
frames: 1
grid:
  columns: 1
  rows: 1
...
# Rocket Launcher Bracing — `item_body_pose__rocket_launcher_bracing`
...
TARGET: Rocket Launcher Bracing.
A reusable full-body equipment pose template for Rocket Launcher Bracing. Preserve the Ethic Brawl side-view fighter proportions while making grip, weight, recoil, and silhouette mechanically unambiguous.
