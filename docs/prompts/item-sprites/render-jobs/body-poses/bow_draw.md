...
job_id: "item_body_pose__bow_draw"
status: pending_render
output_image: "assets/sprites/items/bow_draw.png"
frames: 1
grid:
  columns: 1
  rows: 1
...
# Bow Draw — `item_body_pose__bow_draw`
...
TARGET: Bow Draw.
A reusable full-body equipment pose template for Bow Draw. Preserve the Ethic Brawl side-view fighter proportions while making grip, weight, recoil, and silhouette mechanically unambiguous.
