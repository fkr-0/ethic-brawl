...
job_id: "item_body_pose__computer_terminal_ion_cannon_deploy"
status: pending_render
output_image: "assets/sprites/items/computer_terminal_ion_cannon_deploy.png"
frames: 1
grid:
  columns: 1
  rows: 1
...
# Computer Terminal Ion Cannon Deploy — `item_body_pose__computer_terminal_ion_cannon_deploy`
...
TARGET: Computer Terminal Ion Cannon Deploy.
A reusable full-body equipment pose template for Computer Terminal Ion Cannon Deploy. Preserve the Ethic Brawl side-view fighter proportions while making grip, weight, recoil, and silhouette mechanically unambiguous.
