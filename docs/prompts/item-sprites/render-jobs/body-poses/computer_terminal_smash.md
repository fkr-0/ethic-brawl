...
job_id: "item_body_pose__computer_terminal_smash"
status: pending_render
output_image: "assets/sprites/items/computer_terminal_smash.png"
frames: 1
grid:
  columns: 1
  rows: 1
...
# Computer Terminal Smash — `item_body_pose__computer_terminal_smash`
...
TARGET: Computer Terminal Smash.
A reusable full-body equipment pose template for Computer Terminal Smash. Preserve the Ethic Brawl side-view fighter proportions while making grip, weight, recoil, and silhouette mechanically unambiguous.
