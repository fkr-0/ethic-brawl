...
job_id: "item_body_pose__rocket_launcher_fire"
status: pending_render
output_image: "assets/sprites/items/rocket_launcher_fire.png"
frames: 1
grid:
  columns: 1
  rows: 1
...
# Rocket Launcher Fire — `item_body_pose__rocket_launcher_fire`
...
TARGET: Rocket Launcher Fire.
A reusable full-body equipment pose template for Rocket Launcher Fire. Preserve the Ethic Brawl side-view fighter proportions while making grip, weight, recoil, and silhouette mechanically unambiguous.
