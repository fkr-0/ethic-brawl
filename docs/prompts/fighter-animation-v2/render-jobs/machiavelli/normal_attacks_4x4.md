...
job_id: "machiavelli__normal_attacks_4x4"
status: pending_render
output_image: "assets/sprites/roster/machiavelli/source/animation-v2/machiavelli_normal_attacks_4x4.png"
frames: 16
grid:
  columns: 4
  rows: 4
...
# Niccolò Machiavelli — `normal_attacks_4x4`

This file is one complete Animation v2 render job. Copy only the text in the **Prompt** block into the rendering model.

## Render target

- Output image: `assets/sprites/roster/machiavelli/source/animation-v2/machiavelli_normal_attacks_4x4.png`
...
1. Court Feint: pose — false bow into hidden-hand poke; compact VFX — tiny oxblood slash; gameplay read — deceptive opener.
2. Prince's Edict: pose — diagonal cloak slash plus thrust; compact VFX — oxblood slash and steel glint; gameplay read — launcher pressure.
3. Palace Coup: pose — low-to-high cloak-banner strike; compact VFX — magenta crack; gameplay read — heavy launcher.
