...
job_id: "schmitt__normal_attacks_4x4"
status: rendered_unreviewed
output_image: "assets/sprites/roster/schmitt/source/animation-v2/schmitt_normal_attacks_4x4.png"
frames: 16
grid:
  columns: 4
  rows: 4
...
# Carl Schmitt — `normal_attacks_4x4`

This file is one complete Animation v2 render job. Copy only the text in the **Prompt** block into the rendering model.

## Render target

- Output image: `assets/sprites/roster/schmitt/source/animation-v2/schmitt_normal_attacks_4x4.png`
...
1. Decision Jab: pose — short armored decree punch; compact VFX — white border tick; gameplay read — solid opener.
2. Jurist Crush: pose — tablet forearm smash; compact VFX — red authority slash; gameplay read — pressure hit.
3. Border Kick: pose — stiff boot through rectangle line; compact VFX — gray-white wall crack; gameplay read — heavy ender.
