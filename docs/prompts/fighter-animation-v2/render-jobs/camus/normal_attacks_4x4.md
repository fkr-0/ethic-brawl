...
job_id: "camus__normal_attacks_4x4"
status: pending_render
output_image: "assets/sprites/roster/camus/source/animation-v2/camus_normal_attacks_4x4.png"
frames: 16
grid:
  columns: 4
  rows: 4
...
# Albert Camus — `normal_attacks_4x4`

This file is one complete Animation v2 render job. Copy only the text in the **Prompt** block into the rendering model.

## Render target

- Output image: `assets/sprites/roster/camus/source/animation-v2/camus_normal_attacks_4x4.png`
...
1. Absurd Jab: pose — economical lead jab; compact VFX — tiny smoke snap; gameplay read — fast interrupting poke.
2. Rebel Backfist: pose — half-turn backfist with smoke crescent; compact VFX — gray arc with void-teal edge; gameplay read — mid pressure and whiff punish.
3. Sisyphus Heel: pose — precise lateral heel or heel-drop; compact VFX — sun glint at heel; gameplay read — heavy chain finisher.
