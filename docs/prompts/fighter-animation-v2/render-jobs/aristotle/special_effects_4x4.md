...
job_id: "aristotle__special_effects_4x4"
status: pending_render
output_image: "assets/sprites/roster/aristotle/source/animation-v2/aristotle_special_effects_4x4.png"
frames: 16
grid:
  columns: 4
  rows: 4
...
# Aristotle — `special_effects_4x4`

This file is one complete Animation v2 render job. Copy only the text in the **Prompt** block into the rendering model.

## Render target

- Output image: `assets/sprites/roster/aristotle/source/animation-v2/aristotle_special_effects_4x4.png`
...
```text
Create a production-ready pixel-art VFX sprite sheet for ETHIC BRAWL: aristotle.

Character identity reference: Aristotle — The Peripatetic; role: balanced adaptive fighter.
...
1. B>A — Golden Mean Palm: startup — staff draws centerline; active — palm and staff strike together; impact or sustain — two gold impacts; recovery — exact centered recovery.
2. B<A — Teleology Counter: startup — staff crosses chest; active — bronze category bracket guard; impact or sustain — pushback logic pulse; recovery — staff vertical rest.
3. B^A — Prime Mover Lift: startup — knees dip staff down; active — upward staff lift; impact or sustain — gold ring lifts from floor; recovery — overhead follow-through.
4. BvJ — Virtue Balance Field: startup — plants staff opens scroll hand; active — gold circle and triangle form; impact or sustain — symmetrical rings pulse; recovery — stands centered.
