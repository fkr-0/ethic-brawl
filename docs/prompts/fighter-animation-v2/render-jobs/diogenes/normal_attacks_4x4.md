...
job_id: "diogenes__normal_attacks_4x4"
status: pending_render
output_image: "assets/sprites/roster/diogenes/source/animation-v2/diogenes_normal_attacks_4x4.png"
frames: 16
grid:
  columns: 4
  rows: 4
...
# Diogenes of Sinope — `normal_attacks_4x4`

This file is one complete Animation v2 render job. Copy only the text in the **Prompt** block into the rendering model.

## Render target

- Output image: `assets/sprites/roster/diogenes/source/animation-v2/diogenes_normal_attacks_4x4.png`
...
1. Barrel Flick: pose — short low knuckle or palm flick from a guarded hunch, as if dismissing an opponent; compact VFX — tiny ochre dust snap, no actual barrel required; gameplay read — fast interrupting poke.
2. Lantern Swipe: pose — compact hooking swipe led by the lantern hand while the rear shoulder protects the chin; compact VFX — narrow lantern-gold crescent with a tiny cyan truth spark; gameplay read — medium-range pressure strike.
3. Dog's Kick: pose — scrappy rising knee into a short shin or heel kick, torso still hunched; compact VFX — dusty contact burst and one bronze edge flash; gameplay read — heavy launcher-flavored ender.
