...
job_id: "kant__normal_attacks_4x4"
status: rendered_unreviewed
output_image: "assets/sprites/roster/kant/source/animation-v2/kant_normal_attacks_4x4.png"
frames: 16
grid:
  columns: 4
  rows: 4
...
# Immanuel Kant — `normal_attacks_4x4`

This file is one complete Animation v2 render job. Copy only the text in the **Prompt** block into the rendering model.

## Render target

- Output image: `assets/sprites/roster/kant/source/animation-v2/kant_normal_attacks_4x4.png`
...
1. Maxim Jab: pose — small exact cane poke; compact VFX — blue law tick; gameplay read — precise opener.
2. Duty Palm: pose — rigid palm/book push; compact VFX — gold constraint bracket; gameplay read — control pressure.
3. Sublime Kick: pose — stiff upward kick with coat flare; compact VFX — violet star spark; gameplay read — anti-air ender.
