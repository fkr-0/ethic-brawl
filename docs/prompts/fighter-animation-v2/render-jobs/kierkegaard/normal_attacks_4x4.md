...
job_id: "kierkegaard__normal_attacks_4x4"
status: rendered_unreviewed
output_image: "assets/sprites/roster/kierkegaard/source/animation-v2/kierkegaard_normal_attacks_4x4.png"
frames: 16
grid:
  columns: 4
  rows: 4
...
# Søren Kierkegaard — `normal_attacks_4x4`

This file is one complete Animation v2 render job. Copy only the text in the **Prompt** block into the rendering model.

## Render target

- Output image: `assets/sprites/roster/kierkegaard/source/animation-v2/kierkegaard_normal_attacks_4x4.png`
...
1. Irony Jab: pose — small hesitant cane poke that commits late; compact VFX — pink irony tick; gameplay read — tricky opener.
2. Anxiety Cut: pose — quick diagonal coat-and-cane slash; compact VFX — ink-blue smear; gameplay read — risk pressure.
3. Faith Heel: pose — sudden committed leap kick; compact VFX — gold spark at foot; gameplay read — leap ender.
