...
job_id: "deleuze_guattari__reactions_knockdown_4x4"
status: rendered_unreviewed
output_image: "assets/sprites/roster/deleuze_guattari/source/animation-v2/deleuze_guattari_damage_recovery_4x4.png"
frames: 16
grid:
  columns: 4
  rows: 4
...
# Gilles Deleuze / Félix Guattari — `reactions_knockdown_4x4`

This file is one complete Animation v2 render job. Copy only the text in the **Prompt** block into the rendering model.

## Render target

- Output image: `assets/sprites/roster/deleuze_guattari/source/animation-v2/deleuze_guattari_damage_recovery_4x4.png`
