...
job_id: "deleuze_guattari__normal_attacks_4x4"
status: rendered_unreviewed
output_image: "assets/sprites/roster/deleuze_guattari/source/animation-v2/deleuze_guattari_normal_attacks_4x4.png"
frames: 16
grid:
  columns: 4
  rows: 4
...
# Gilles Deleuze / Félix Guattari — `normal_attacks_4x4`

This file is one complete Animation v2 render job. Copy only the text in the **Prompt** block into the rendering model.

## Render target

- Output image: `assets/sprites/roster/deleuze_guattari/source/animation-v2/deleuze_guattari_normal_attacks_4x4.png`
...
1. Concept Jab: pose — two-beat asymmetrical jab from main hand and echo shoulder; compact VFX — green rhizome tick; gameplay read — trick opener.
2. Assemblage Sweep: pose — scarf-and-root side sweep; compact VFX — magenta-green arc; gameplay read — chaos pressure.
3. Plateau Kick: pose — rising knee with paper burst; compact VFX — blue plateau spark; gameplay read — launcher-flavored ender.
