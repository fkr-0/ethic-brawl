...
job_id: "leibniz__normal_attacks_4x4"
status: pending_render
output_image: "assets/sprites/roster/leibniz/source/animation-v2/leibniz_normal_attacks_4x4.png"
frames: 16
grid:
  columns: 4
  rows: 4
...
# Gottfried Wilhelm Leibniz — `normal_attacks_4x4`

This file is one complete Animation v2 render job. Copy only the text in the **Prompt** block into the rendering model.

## Render target

- Output image: `assets/sprites/roster/leibniz/source/animation-v2/leibniz_normal_attacks_4x4.png`
...
1. Monad Jab: pose — exact straight lead-hand thrust from a compact aristocratic guard; compact VFX — one tiny cyan monad point at the knuckles; gameplay read — fast precise interrupting poke.
2. Calculus Palm: pose — measured open-palm step tracing a short rising curve with the rear hand balancing; compact VFX — thin gold tangent arc and two small sequential contact points; gameplay read — double-tap medium pressure strike.
3. Possible Worlds Arc: pose — broad but controlled compass-like forearm or coat-assisted sweep ending in a planted stance; compact VFX — compact violet-gold arc with two faint alternate-position echoes; gameplay read — heavy knockback finisher.
