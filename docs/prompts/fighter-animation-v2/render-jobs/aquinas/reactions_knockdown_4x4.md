...
job_id: "aquinas__reactions_knockdown_4x4"
status: pending_render
output_image: "assets/sprites/roster/aquinas/source/animation-v2/aquinas_damage_recovery_4x4.png"
frames: 16
grid:
  columns: 4
  rows: 4
...
# Thomas Aquinas — `reactions_knockdown_4x4`

This file is one complete Animation v2 render job. Copy only the text in the **Prompt** block into the rendering model.

## Render target

- Output image: `assets/sprites/roster/aquinas/source/animation-v2/aquinas_damage_recovery_4x4.png`
