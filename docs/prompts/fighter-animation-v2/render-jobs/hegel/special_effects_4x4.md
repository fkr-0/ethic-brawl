...
job_id: "hegel__special_effects_4x4"
status: pending_render
output_image: "assets/sprites/roster/hegel/source/animation-v2/hegel_special_effects_4x4.png"
frames: 16
grid:
  columns: 4
  rows: 4
...
# G.W.F. Hegel — `special_effects_4x4`

This file is one complete Animation v2 render job. Copy only the text in the **Prompt** block into the rendering model.

## Render target

- Output image: `assets/sprites/roster/hegel/source/animation-v2/hegel_special_effects_4x4.png`
...
```text
Create a production-ready pixel-art VFX sprite sheet for ETHIC BRAWL: hegel.

Character identity reference: G.W.F. Hegel — The Dialectician; role: evolving combo engine.
