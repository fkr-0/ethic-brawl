...
job_id: "hegel__normal_attacks_4x4"
status: rendered_unreviewed
output_image: "assets/sprites/roster/hegel/source/animation-v2/hegel_normal_attacks_4x4.png"
frames: 16
grid:
  columns: 4
  rows: 4
...
# G.W.F. Hegel — `normal_attacks_4x4`

This file is one complete Animation v2 render job. Copy only the text in the **Prompt** block into the rendering model.

## Render target

- Output image: `assets/sprites/roster/hegel/source/animation-v2/hegel_normal_attacks_4x4.png`
...
1. Thesis Tap: pose — short cane assertion; compact VFX — blue thesis spark; gameplay read — starter.
2. Antithesis Break: pose — cross-body cane/book strike; compact VFX — blue-gold crossing slash; gameplay read — advancing pressure.
3. Synthesis Crown: pose — cane rises book opens; compact VFX — small crown flash; gameplay read — launcher ender.
