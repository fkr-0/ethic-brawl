# Gilles Deleuze / Félix Guattari — Animation v2 Prompts

Rendered from `docs/prompts/fighter-animation-v2/prompt-pack.yml` (v1)
by substituting `characters/deleuze_guattari/prompts.yml`.
Output directory: `assets/sprites/roster/deleuze_guattari/source/animation-v2`
Sheets: 5 · Frames per sheet: 16 (4×4) · Integration status: prompt-only
Generated: 2026-07-19 · Review with `REVIEW_CHECKLIST.md` before slicing.

---

## idle_turn_4x4

Output: `assets/sprites/roster/deleuze_guattari/source/animation-v2/deleuze_guattari_idle_turn_4x4.png`
Clips: `idle_v2` (loop), `turn_left_v2` (once), `turn_right_v2` (once)
...
Output: `assets/sprites/roster/deleuze_guattari/source/animation-v2/deleuze_guattari_walk_forward_backward_4x4.png`
Clips: `walk_forward_v2` (loop), `walk_backward_v2` (loop)
...
Output: `assets/sprites/roster/deleuze_guattari/source/animation-v2/deleuze_guattari_run_start_loop_stop_4x4.png`
Clips: `run_start_v2` (once), `run_v2` (loop), `run_stop_v2` (once)
...
Output: `assets/sprites/roster/deleuze_guattari/source/animation-v2/deleuze_guattari_jump_land_recovery_4x4.png`
Clips: `jump_takeoff_v2` (once), `jump_air_v2` (once), `land_v2` (once), `land_recovery_v2` (once)
...
Output: `assets/sprites/roster/deleuze_guattari/source/animation-v2/deleuze_guattari_lane_guard_crouch_4x4.png`
Clips: `lane_away_v2` (once), `lane_toward_v2` (once), `crouch_v2` (once), `guard_v2` (once)
